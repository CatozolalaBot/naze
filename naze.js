...
const nyoutube = ('© Catoz\nYoutube :\nhttps://youtube.com/channel/UCEaeLiz0MWBU14ttbtRx6-w')  //ubah di config biar ngk emror
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
            ...
            m.reply('Menunggu partner Mengetik Y' + (text ? ` mengetik command dibawah ini ${prefix}${command} ${text}` : ''))
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/V2SPnWP/images.jpg' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silakan hubungi owner*\n\n*Atau klik link dibawah ini*\n_https://saweria.co/Catozolala_\n\n*Atau Transfer via*\n- *Gopay Dana Ovo Qris ShopeePay*\n Ke nomer berikut : 085856382245\n\n_Terima kasih bagi yang sudah donasi_`
                 }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('https://wa.me/6281938830020')
            }
            break		 
            case 'chat': {
...
⭔ Url : ${anu.url}`,
	    ...
	    break
            ...
            break
case 'loli': case 'hentailoli': {
            let buttons = [
                    {buttonId: `loli`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/wallpaper/nsfwloli?apikey=APIKEY' },
                    caption: `_Nih Loli Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'ahegao': case 'hentaiahegao': {
            let buttons = [
                    {buttonId: `ahegao`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/ahegao?apikey=APIKEY' },
                    caption: `_Nih Ahegao Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'ass': case 'hentaiass': {
            let buttons = [
                    {buttonId: `ass`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/ass?apikey=APIKEY' },
                    caption: `_Nih ass Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'bdsm': case 'hentaibdsm': {
            let buttons = [
                    {buttonId: `bdsm`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/bdsm?apikey=APIKEY' },
                    caption: `_Nih Bdsm Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'blowjob': case 'hentaiblowjob': {
            let buttons = [
                    {buttonId: `blowjob`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/blowjob?apikey=APIKEY' },
                    caption: `_Nih Blowjob Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'cuckold': case 'hentaicuckold': {
            let buttons = [
                    {buttonId: `cuckold`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/cuckold?apikey=APIKEY' },
                    caption: `_Nih Cuckold Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'cum': case 'hentaicum': {
            let buttons = [
                    {buttonId: `cum`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/cum?apikey=APIKEY' },
                    caption: `_Nih Cum Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'ero': case 'hentaiero': {
            let buttons = [
                    {buttonId: `ero`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/ero?apikey=APIKEY' },
                    caption: `_Nih Ero Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'femdom': case 'hentaifemdom': {
            let buttons = [
                    {buttonId: `femdom`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/femdom?apikey=APIKEY' },
                    caption: `_Nih Femdom Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'foot': case 'hentaifoot': {
            let buttons = [
                    {buttonId: `foot`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/foot?apikey=APIKEY' },
                    caption: `_Nih Foot Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'hentai': case 'hentaihentai': {
            let buttons = [
                    {buttonId: `hentai`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/hentai?apikey=APIKEY' },
                    caption: `_Nih Hentai Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'jahy': case 'hentaijahy': {
            let buttons = [
                    {buttonId: `jahy`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/jahy?apikey=APIKEY' },
                    caption: `_Nih Jahyi Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'manga': case 'hentaimanga': {
            let buttons = [
                    {buttonId: `manga`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/manga?apikey=APIKEY' },
                    caption: `_Nih Manga Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'mstb': case 'hentaimstb': {
            let buttons = [
                    {buttonId: `mstbi`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/masturbation?apikey=APIKEY' },
                    caption: `_Nih Mstb Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'neko': case 'hentaineko': {
            let buttons = [
                    {buttonId: `neko`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/neko?apikey=APIKEY' },
                    caption: `_Nih Neko Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'orgy': case 'hentaiorgy': {
            let buttons = [
                    {buttonId: `orgy`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/orgy?apikey=APIKEY' },
                    caption: `_Nih Orgy Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'panties': case 'hentaipanties': {
            let buttons = [
                    {buttonId: `panties`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/panties?apikey=APIKEY' },
                    caption: `_Nih Pantiesi Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'pussy': case 'hentaipussy': {
            let buttons = [
                    {buttonId: `pussy`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/pussy?apikey=APIKEY' },
                    caption: `_Nih Pussy Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'tentacles': case 'hentaitentacles': {
            let buttons = [
                    {buttonId: `tentacles`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/tentacles?apikey=APIKEY' },
                    caption: `_Nih Tentacles Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'yuri': case 'hentaiyuri': {
            let buttons = [
                    {buttonId: `yuri`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/yuri?apikey=APIKEY' },
                    caption: `_Nih Yuri Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'zettai': case 'hentaizettai': {
            let buttons = [
                    {buttonId: `zettai`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/nsfw/zettai?apikey=APIKEY' },
                    caption: `_Nih Zettai Nya_\n_Dosa di tanggung sendiri ❗_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
...
case 'waifu2': {
            let buttons = [
                    {buttonId: `waifu2`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://apilolhumsn.herokuapp.com/api/wallpaper/waifu2?apikey=APIKEY' },
                    caption: `_Random Waifu2_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
...
case 'shota': {
            let buttons = [
                    {buttonId: `shota`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/wallpaper/shota?apikey=APIKEY' },
                    caption: `_Random Shota_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
...
case 'animeloli': {
            let buttons = [
                    {buttonId: `animeloli`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/wallpaper/loli?apikey=APIKEY' },
                    caption: `_Random Animeloli_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
...
case 'yotsuba': {
            let buttons = [
                    {buttonId: `yotsuba`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/wallpaper/yotsuba?apikey=APIKEY' },
                    caption: `_Random Yotsuba_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
...
case 'cogan': {
            let buttons = [
                    {buttonId: `cogan`, buttonText: {displayText: 'Next Image'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/wallpaper/cogan2?apikey=APIKEY' },
                    caption: `_Random Cogan_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
...
case 'cecan': {
            let buttons = [
                ...
                let buttonMessage = {
                    image: { url: 'https://zenpi.herokuapp.com/api/wallpaper/cecan2?apikey=APIKEY' },
                    caption: `_Random Cecan_`,
                    footer: nyoutube,
                    buttons: buttons,
                    headerType: 4
                }
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) throw `Example : ${prefix + command} 6281938830020`
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            case 'owner': case 'creator': {
                ...
                m.reply('*_Hai kak itu owner ku ◉⁠‿⁠◉_*')
            }
            break
            case 'playstore': {
...
╰──❍`
            ...
            let buttons = [{ buttonId: 'list', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📋Allmenu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
...
╰──❍`
                ...
                {title: "Nsfw", rowId: `nsfw`, description: `🤨Nsfw Menu`},
                ...
                {title: "Sound", rowId: `msound`, description: `🎵 Sound Menu`},
...
│
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📋Allmenu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📋Allmenu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, msfw, nyoutube, m)
            }
            break
            case 'msearch': {
sarch = `┌──⭓ *Search Menu*
...
└───────⭓Sound Menu🎵`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📋Allmenu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, ond, nyoutube, m)
            }
            break
            case 'allmenu': {
            let ownernya = ownernomer + '@s.whatsapp.net'
...
┌──⭓ *Rules❗*
│
│⭔ *_Dilarang telpon bot [auto blcok]_*
│⭔ *_Dilarang sepam bot_*
│⭔ *_Dilarang kirim virtek_*
│⭔ *_Jika ada yang eror silahkan ketik #owner_*
└───────⭓

_Jangan lupa donasi ngab_\n_Jangan Ngarep Free Mulu_`
...
case 'asslamualaikum': case 'assalamualaikum':{
m.reply('Waalaikummusallam')
}
            break		 
            case 'p':{
m.reply('Wajib jawab Asslamualaikum ❗')
}
break
case 'test': case 'tes': case 'testing':{
m.reply('*_Aktifed✅_*')
}
break
case 'halo':{
...
await naze.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `_Nih Bokep Nya_\n_Dosa di tanggung sendiri ❗_` }, { quoted: m })
}
break
case 'grupwa': case 'grup': case 'ytta': {
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let ments = [ownernya, me, ini_mark]
            let kukiw = `*${ucapanWaktu}*
...
╰──❍`
                let sections = [
                {
                title: "CHANGE GRUP WA",
                rows: [
                {title: "✍🏻 BELAJAR NAHWU PEMULA📖", description: `https://chat.whatsapp.com/77XlK5jHuqN4qvFOOef4rS`},
                {title: "❗ BELAJAR SAHAM TOGA 👏", description: `https://chat.whatsapp.com/9L7OHaP0NMML1scwuq3303`},
                {title: "1 Muslimah Belajar Sunnah", description: `https://chat.whatsapp.com/Daa5V1NbVax76n97a9wbqM`},
                {title: "1#Internet Marketing", description: `https://chat.whatsapp.com/KKt3OHKYPp8KKpnWYBbwSS`},
                {title: "⃣ فهم النص MEMAHAMI TEKS", description: `https://chat.whatsapp.com/BZLt4qmNx8eL1ThNk1T6L8`},
                {title: "⚁✈Mudah Belajar Import🚢🌏", description: `https://chat.whatsapp.com/FU98rmWu2UXA0hafL5nGvH`},
                {title: "🇮🇩ENGLISH DISCUSS🇦🇺", description: 'https://chat.whatsapp.com/0HqCHIYErYBEvKZ7mq7r7a'},
                {title: "🎉ENGLISH🇬🇧CLUB🎊🇮🇩", description: `https://chat.whatsapp.com/6EY4ftlkWeSF8RhYcL23GI`},
                {title: "日本語グループ", description: `https://chat.whatsapp.com/AVSpx33hFRT2d46yQCAhq6u`},
                {title: "日本語のクラブ", description: 'https://chat.whatsapp.com/FH01IsjBxyu4FafqFve5I4'},
                {title: "🤩Belajar jadi pengusaha🤩", description: `https://chat.whatsapp.com/25wjVv0RqnTFTbVgwF40Nt`},
                {title: "🙏📚BELAJAR TAJWID&TARTIL📚🙏", description: `https://chat.whatsapp.com/FqY0TUFdtqp7lqQXlgQUaw`},
                {title: "🔰Bahasa Arab Mudah🌱", description: `https://chat.whatsapp.com/K50epI1wc23H47lRdbThv7`},
                {title: "📚 Bispemula Official 1⃣", description: `https://chat.whatsapp.com/Gppjc2GMuql4b1FcuGqvyQ"`},
                {title: "ʙᴇʟᴀᴊᴀʀ ᴛᴇɴᴛᴀɴɢ iKLAN", description: `https://chat.whatsapp.com/2nbbg6fdaLw0z01gZRmBgP`},
                {title: "7 HARI PERUBAHAN", description: `https://chat.whatsapp.com/GDrznZp3fK817Migu6iNHr"`},
                {title: "4", description: `https://chat.whatsapp.com/GgCqRRVqVdkJTT9yXEzrG2`},
                {title: "🕌Kajian ilmu Hadits🕌", description: `https://chat.whatsapp.com/9e8Bk1O50pw7MetkHvMzza`},
                {title: "🌹ⲘɌ.Ɖ₦.₱01🌹", description: `https://chat.whatsapp.com/84iOZmjuMLDAPiMayi7PXY"`},
                {title: "🍗Belajar membuat kentuky🌶", description: `https://chat.whatsapp.com/HdKuvISYmj9GRJxJtveGel`}
                ]
                },
                ]
                naze.sendListMsg(m.chat, kukiw, nyoutube, `*Hello Kak ${pushname}*!`, `Pilih Menu`, sections, m)
